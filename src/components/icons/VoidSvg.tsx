...
const VoidSvg = (props: Props) => {
    ...
    return (
        <svg data-name="Layer 1" viewBox="0 0 797.5 834.5" width="100%" height={height}>
            <ellipse cx={308.5} cy={780} rx={308.5} ry={54.5} fill={accentColor} />
            <circle cx={496} cy={301.5} r={301.5} fill={accentColor} />
            ...
            <path
                ...
                fill={hairColor}
            />
            <circle cx={559} cy={744.5} r={43} fill={primaryColor} />
            <circle cx={54} cy={729.5} r={43} fill={primaryColor} />
            <circle cx={54} cy={672.5} r={31} fill={primaryColor} />
            <circle cx={54} cy={624.5} r={22} fill={primaryColor} />
        </svg>
    );
};
